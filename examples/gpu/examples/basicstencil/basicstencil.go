...
func _init(context *common.Context) error {
	...
	transferData[0] = common.NewPosColorVert(-0.5, -0.5, 0, 255, 255, 0, 255)
	transferData[1] = common.NewPosColorVert(0.5, -0.5, 0, 255, 255, 0, 255)
	transferData[2] = common.NewPosColorVert(0, 0.5, 0, 255, 255, 0, 255)
	transferData[3] = common.NewPosColorVert(-1, -1, 0, 255, 0, 0, 255)
	transferData[4] = common.NewPosColorVert(1, -1, 0, 0, 255, 0, 255)
	transferData[5] = common.NewPosColorVert(0, 1, 0, 0, 0, 255, 255)
